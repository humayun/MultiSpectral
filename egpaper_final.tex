...
In medical imaging, computer aided detection (CADe), also called computer aided diagnosis (CADx) systems are Popular now-a-day in medicine that assist doctors in interpretation of medical images. CAD systems are extensively used in the detection and differential diagnosis of many different types of abnormalities in medical images obtained using different imaging modalities. A large amount of research and state-of-the-arts methods are available CAD in radiology ~\cite{giger2004,sonka2000,bankman2000,erickson2002,
summers2003}.
